  ...
  return (
    <>
     <div className="w-full h-[679px] py-12 my-20 bg-[#ffb524]">
      <div className='w-full h-[600px] flex flex-col md:flex-row gap-20 px-60'>
        <div className='banner-left w-[50%] h-[100%] overflow-hidden'>
          <div className=' w-[100%] h-100 flex flex-col  justify-center '>
            ...
            <p className='text-[#45595b] pr-20 text-wrap'>The generated Lorem Ipsum is therefore always free from repetition injected humour, or non-characteristic words etc.</p>
        ...
        <div className='banner-right md:w-[50%] w-[100%] h-[100%]'>

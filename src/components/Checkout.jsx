  ...
  <div className="w-[60%]  py-40 gap-10 flex flex-col md:flex-row md:items-start md:px-10 ">
      ...
      <div class=" rounded-lg border bg-slate-100 shadow-md md:mt-0 md:w-1/3 p-6 ">
        ...
        <div class="flex">
          ...
          <button onClick={() => alert("please fill form properly")} class=" mr-0 mt-6 w-full rounded-md bg-[#ffb524] py-1.5 font-medium text-blue-50 hover:bg-slate-500">Place Order</button>
          <NavLink to={'/store'}>

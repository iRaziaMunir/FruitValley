			...
			<footer className="bg-[#45595b]" aria-labelledby="footer-heading">
				...
				<div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
					<div className="xl:grid xl:grid-cols-1 xl:gap-8">
						<div className="space-y-8">
							...
							<div className="flex space-x-6">
								<NavLink className="hover:bg-[#ffb524] text-[#ffb524] hover:text-black border-1 border-[#ffb524] rounded-full p-2">
									<TiSocialFacebook />
								</NavLink>
								<NavLink className="hover:bg-[#ffb524] text-[#ffb524] hover:text-black border-1 border-[#ffb524] rounded-full p-2">
									{" "}
					...
					<div className="mt-16 border-t border-[#ffb524] text-[#ffb524] pt-8 sm:mt-20 lg:mt-24 lg:flex items-center justify-between sm:block">
						<div className="">
							<span className="text-white flex items-center text-xm ">
								<MdCopyright className="bg-white text-black rounded-full mr-2" />
						...
						<div>
							<h3 className="text-white  text-md">
								Designed By
								<span className="text-[#81c408] text-xm">
									{" "}
									Rzi
								</span>
							</h3>
